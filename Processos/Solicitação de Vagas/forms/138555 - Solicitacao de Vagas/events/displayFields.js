//---------------- NOVA FUNÇÃO ----------------\\
// CAPTURAR DADOS DO USUÁRIO E INSERIR NO FORMULÁRIO
function displayFields(form,customHTML){
	...
	if (state == 0) { 
		...
		var email = consulta.getValue(0,"mail");
		form.setValue("solicitante",usuario);
		form.setValue("email",email);
		form.setValue("codSolicitante",usuario_atual);
		form.setValue("dataSolicitacao",getDateNow("tds"));
	}
}

//---------------- NOVA FUNÇÃO ----------------\\
//1.00.00 - GERAR DATA FORMATADA
